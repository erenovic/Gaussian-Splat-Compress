...
This repository contains the code for the experiments on "Gaussian Splat Compression".
...
```shell
# HTTPS
git clone https://github.com/erenovic/Gaussian-Splat-Compress.git --recursive
```
